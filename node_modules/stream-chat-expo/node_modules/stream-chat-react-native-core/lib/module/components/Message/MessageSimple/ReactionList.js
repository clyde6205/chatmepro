...
var areEqual = function areEqual(prevProps, nextProps) {
  ...
  var reactionsEqual = Array.isArray(prevReactions) && Array.isArray(nextReactions) ? prevReactions.length === nextReactions.length && prevReactions.every(function (_ref3, index) {
    var _nextMessage$latest_r2, _nextMessage$latest_r3, _nextMessage$latest_r4, _nextMessage$latest_r5;
    var count = _ref3.count,
      type = _ref3.type;
    return type === ((_nextMessage$latest_r2 = nextMessage.latest_reactions) == null ? void 0 : (_nextMessage$latest_r3 = _nextMessage$latest_r2[index]) == null ? void 0 : _nextMessage$latest_r3.type) && count === ((_nextMessage$latest_r4 = nextMessage.latest_reactions) == null ? void 0 : (_nextMessage$latest_r5 = _nextMessage$latest_r4[index]) == null ? void 0 : _nextMessage$latest_r5.count);
