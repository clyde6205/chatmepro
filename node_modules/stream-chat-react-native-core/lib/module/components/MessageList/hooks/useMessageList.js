...
var _messageListPrevNextState = require("../../../state-store/message-list-prev-next-state");
...
var shouldIncludeMessageInList = exports.shouldIncludeMessageInList = function shouldIncludeMessageInList(message, options) {
  ...
  var isSender = ((_message$user = message.user) == null ? void 0 : _message$user.id) === userId;
...
var useMessageList = exports.useMessageList = function useMessageList(params) {
  var noGroupByUser = params.noGroupByUser,
    ...
    _params$isFlashList = params.isFlashList,
    isFlashList = _params$isFlashList === void 0 ? false : _params$isFlashList;
  ...
  var _usePaginatedMessageL = (0, _PaginatedMessageListContext.usePaginatedMessageListContext)(),
    ...
    viewabilityChangedCallback = _usePaginatedMessageL.viewabilityChangedCallback;
  ...
  var _useState = (0, _react.useState)(function () {
      return new _messageListPrevNextState.MessagePreviousAndNextMessageStore();
    }),
    _useState2 = (0, _slicedToArray2.default)(_useState, 1),
    messageListPreviousAndNextMessageStore = _useState2[0];
  ...
  }, [getMessagesGroupStyles, hideDateSeparators, maxTimeBetweenGroupedMessages, processedMessageList, noGroupByUser, client.userID]);
