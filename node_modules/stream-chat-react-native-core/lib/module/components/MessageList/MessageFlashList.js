...
var MessageFlashListWithContext = function MessageFlashListWithContext(props) {
  ...
  var indexToScrollToRef = (0, _react.useRef)(undefined);
  var initialIndexToScrollTo = (0, _react.useMemo)(function () {
    return targetedMessage ? processedMessageList.findIndex(function (message) {
  ...
  (0, _react.useEffect)(function () {
    ...
    if (!didMergeMessageSetsWithNoUpdates) {
      ...
      if (shouldScrollToRecentOnNewOwnMessage) {
        ...
        (_flashListRef$current2 = flashListRef.current) == null || _flashListRef$current2.scrollToEnd({
          animated: true
        });
      }
    }
  ...
  var flatListContentContainerStyle = (0, _react.useMemo)(function () {
    return [styles.contentContainer, contentContainer];
  }, [contentContainer]);
  ...
  var onLayout = (0, _hooks.useStableCallback)(function (e) {
    ...
    (_flashListRef$current3 = flashListRef.current) == null || _flashListRef$current3.scrollToOffset({
