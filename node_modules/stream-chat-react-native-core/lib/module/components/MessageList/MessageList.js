...
var MessageListWithContext = function MessageListWithContext(props) {
  ...
  var autoscrollToTopThreshold = autoscrollToRecent ? isLiveStreaming ? 300 : 10 : undefined;
  ...
  var updateStickyUnreadIndicator = (0, _hooks.useStableCallback)(function (viewableItems) {
    ...
    var lastItem = viewableItems[viewableItems.length - 1];
    if (lastItem) {
      var _channelUnreadState$l;
      var lastItemMessage = lastItem.item;
      var lastItemCreatedAt = lastItemMessage.created_at;
      var unreadIndicatorDate = channelUnreadState == null || (_channelUnreadState$l = channelUnreadState.last_read) == null ? void 0 : _channelUnreadState$l.getTime();
  ...
  var unstableOnViewableItemsChanged = function unstableOnViewableItemsChanged(_ref2) {
  ...
  var stableOnViewableItemsChanged = (0, _react.useCallback)(function (_ref3) {
    ...
    var handleEvent = function () {
      var _ref4 = (0, _asyncToGenerator2.default)(function* (event) {
        ...
        if ((scrollToBottomButtonVisible || channelUnreadState != null && channelUnreadState.first_unread_message_id) && !isMyOwnMessage) {
          var _channelUnreadState$u, _channelUnreadState$l2;
          ...
          setChannelUnreadState(Object.assign({}, channelUnreadState, {
            last_read: (_channelUnreadState$l2 = channelUnreadState == null ? void 0 : channelUnreadState.last_read) != null ? _channelUnreadState$l2 : previousUnreadCount === 0 && previousLastMessage != null && previousLastMessage.created_at ? new Date(previousLastMessage.created_at) : new Date(0),
  ...
  }, [threadList, messageListLengthAfterUpdate, topMessageAfterUpdate == null ? void 0 : topMessageAfterUpdate.id, maximumMessageLimit]);
  (0, _react.useEffect)(function () {
    if (threadList) {
  ...
  }, [channel, threadList, processedMessageList, shouldScrollToRecentOnNewOwnMessageRef, maximumMessageLimit]);
