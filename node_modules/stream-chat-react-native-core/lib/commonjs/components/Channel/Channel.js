...
var _channelUnreadState = require("../../state-store/channel-unread-state");
...
var _MessageBlocked = require("../Message/MessageSimple/MessageBlocked");
...
var ChannelWithContext = function ChannelWithContext(props) {
  ...
  var additionalKeyboardAvoidingViewProps = props.additionalKeyboardAvoidingViewProps,
    ...
    _props$allowConcurren = props.allowConcurrentAudioPlayback,
    allowConcurrentAudioPlayback = _props$allowConcurren === void 0 ? false : _props$allowConcurren,
    ...
    _props$disableAttachm = props.disableAttachmentPicker,
    disableAttachmentPicker = _props$disableAttachm === void 0 ? !(0, _native.isImageMediaLibraryAvailable)() : _props$disableAttachm,
    ...
    getMessageGroupStyle = props.getMessageGroupStyle,
    ...
    _props$MessageBlocked = props.MessageBlocked,
    MessageBlocked = _props$MessageBlocked === void 0 ? _MessageBlocked.MessageBlocked : _props$MessageBlocked,
  ...
  var _useState13 = (0, _react.useState)(new _channelUnreadState.ChannelUnreadStateStore()),
    _useState14 = (0, _slicedToArray2.default)(_useState13, 1),
    channelUnreadStateStore = _useState14[0];
  var setChannelUnreadState = (0, _react.useCallback)(function (data) {
  ...
  var _useMessageListPagina = (0, _useMessageListPagination.useMessageListPagination)({
    ...
    rawCopyMessagesStateFromChannel = _useMessageListPagina.copyMessagesStateFromChannel,
  ...
  var _usePrunableMessageLi = (0, _usePrunableMessageList.usePrunableMessageList)({
      maximumMessageLimit: maximumMessageLimit,
      setMessages: rawCopyMessagesStateFromChannel
    }),
    copyMessagesStateFromChannel = _usePrunableMessageLi.setMessages,
    viewabilityChangedCallback = _usePrunableMessageLi.viewabilityChangedCallback;
  ...
  var deleteMessage = (0, _hooks.useStableCallback)(function () {
    var _ref18 = (0, _asyncToGenerator2.default)(function* (message) {
      ...
      } else if (optionsOrHardDelete != null && optionsOrHardDelete.deleteForMe) {
        options = {
          deleteForMe: true
        };
      } else if (optionsOrHardDelete != null && optionsOrHardDelete.hardDelete) {
        options = {
          hardDelete: true
        };
      }
      ...
      var data = yield client.deleteMessage(message.id, options);
  ...
  var attachmentPickerContext = (0, _react.useMemo)(function () {
    return {
      ...
      disableAttachmentPicker: disableAttachmentPicker,
      openPicker: function openPicker() {
        return _openPicker(bottomSheetRef);
      },
      topInset: topInset
    };
  }, [bottomInset, bottomSheetRef, _closePicker, _openPicker, topInset, disableAttachmentPicker]);
  ...
  var audioPlayerContext = (0, _react.useMemo)(function () {
    return {
      allowConcurrentAudioPlayback: allowConcurrentAudioPlayback
    };
                ...
                children: (0, _jsxRuntime.jsx)(_contexts.AttachmentPickerProvider, {
                  ...
                  children: (0, _jsxRuntime.jsx)(_MessageComposerContext.MessageComposerProvider, {
                    ...
                    children: (0, _jsxRuntime.jsx)(_MessageInputContext.MessageInputProvider, {
                      ...
                      children: (0, _jsxRuntime.jsxs)(_AudioPlayerContext.AudioPlayerProvider, {
                        ...
                        children: [(0, _jsxRuntime.jsx)(_reactNative.View, {
                          ...
                          children: children
                        }), !disableAttachmentPicker && (0, _jsxRuntime.jsx)(_AttachmentPicker.AttachmentPicker, Object.assign({
                          ref: bottomSheetRef
