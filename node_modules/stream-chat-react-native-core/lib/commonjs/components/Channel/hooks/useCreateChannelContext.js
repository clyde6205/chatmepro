...
var useCreateChannelContext = exports.useCreateChannelContext = function useCreateChannelContext(_ref) {
  var channel = _ref.channel,
    ...
    channelUnreadStateStore = _ref.channelUnreadStateStore,
  ...
  var readUsersLastReads = readUsers.map(function (_ref2) {
    var _last_read$toISOStrin;
    var last_read = _ref2.last_read;
    return (_last_read$toISOStrin = last_read == null ? void 0 : last_read.toISOString()) != null ? _last_read$toISOStrin : '';
  }).join();
  ...
  }, [channelId, disabled, error, isChannelActive, highlightedMessageId, lastReadTime, loading, membersLength, readUsersLength, readUsersLastReads, targetedMessage, threadList, watcherCount, maximumMessageLimit]);
