...
var _mapReminderToStorable = require("../mappers/mapReminderToStorable");
...
var upsertMessages = exports.upsertMessages = function () {
  var _ref2 = (0, _asyncToGenerator2.default)(function* (_ref) {
    ...
    var storablePolls = [];
    var storableReminders = [];
    var storableLocations = [];
    messages == null || messages.forEach(function (message) {
      ...
      if (message.reminder) {
        storableReminders.push((0, _mapReminderToStorable.mapReminderToStorable)(message.reminder));
      }
      if (message.shared_location) {
        storableLocations.push((0, _mapSharedLocationToStorable.mapSharedLocationToStorable)(message.shared_location));
      }
    });
    ...
    })), (0, _toConsumableArray2.default)(storableReminders.map(function (storableReminder) {
      return (0, _createUpsertQuery.createUpsertQuery)('reminders', storableReminder);
    })), (0, _toConsumableArray2.default)(storableLocations.map(function (storableLocation) {
      return (0, _createUpsertQuery.createUpsertQuery)('locations', storableLocation);
    })));
