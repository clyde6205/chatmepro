...
export declare const MessageListItemContext: React.Context<MessageListItemContextValue>;
export declare const MessageListItemProvider: ({ children, value, }: PropsWithChildren<{
    value?: MessageListItemContextValue;
}>) => React.JSX.Element;
export declare const useMessageListItemContext: () => MessageListItemContextValue;
//# sourceMappingURL=MessageListItemContext.d.ts.map