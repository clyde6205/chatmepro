...
type MessageListPropsWithContext = Pick<AttachmentPickerContextValue, 'closePicker' | 'selectedPicker' | 'setSelectedPicker'> & Pick<OwnCapabilitiesContextValue, 'readEvents'> & Pick<ChannelContextValue, 'channel' | 'channelUnreadState' | 'channelUnreadStateStore' | 'disabled' | 'EmptyStateIndicator' | 'hideStickyDateHeader' | 'loadChannelAroundMessage' | 'loading' | 'LoadingIndicator' | 'markRead' | 'NetworkDownIndicator' | 'reloadChannel' | 'scrollToFirstUnreadThreshold' | 'setChannelUnreadState' | 'setTargetedMessage' | 'StickyHeader' | 'targetedMessage' | 'threadList' | 'maximumMessageLimit'> & Pick<ChatContextValue, 'client'> & Pick<ImageGalleryContextValue, 'setMessages'> & Pick<PaginatedMessageListContextValue, 'loadMore' | 'loadMoreRecent'> & Pick<MessagesContextValue, 'DateHeader' | 'disableTypingIndicator' | 'FlatList' | 'legacyImageViewerSwipeBehaviour' | 'ScrollToBottomButton' | 'myMessageTheme' | 'TypingIndicator' | 'TypingIndicatorContainer' | 'UnreadMessagesNotification'> & Pick<ThreadContextValue, 'loadMoreRecentThread' | 'loadMoreThread' | 'thread' | 'threadInstance'> & {
    /**
