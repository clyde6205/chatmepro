 ...
 */
export declare const MessageFlashList: (props: MessageFlashListProps) => React.JSX.Element;
export {};
//# sourceMappingURL=MessageFlashList.d.ts.map