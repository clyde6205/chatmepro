 ...
 */
export declare const getGroupStyle: ({ message, previousMessage, nextMessage, maxTimeBetweenGroupedMessages, nextMessageDateSeparatorDate, dateSeparatorDate, }: MessageGroupStylesParams) => GroupStyle[];
/**
 * @deprecated in favor of `useMessageGroupStyles` hook instead directly in the Message.
 */
