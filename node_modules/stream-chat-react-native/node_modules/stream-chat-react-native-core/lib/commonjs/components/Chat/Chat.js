...
var ChatWithContext = function ChatWithContext(props) {
  ...
  (0, _react.useEffect)(function () {
    if (client) {
      ...
      client.deviceIdentifier = {
        os: "".concat(_reactNative.Platform.OS, " ").concat(_reactNative.Platform.Version)
      };
  ...
  (0, _react.useEffect)(function () {
    ...
    var initializeDatabase = function initializeDatabase() {
      ...
      _SqliteClient.SqliteClient.initializeDatabase().then((0, _asyncToGenerator2["default"])(_regenerator["default"].mark(function _callee() {
        return _regenerator["default"].wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 3;
              return _DBSyncManager.DBSyncManager.init(client);
            case 3:
            case "end":
    ...
    return function () {
      if (userID && enableOfflineSupport) {
        _SqliteClient.SqliteClient.closeDB();
      }
    };
